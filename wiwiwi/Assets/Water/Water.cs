    ...
    public void GenerateMesh()
    {
        ...
        for (int y = 0; y < NUM_OF_Y_VERTICES; y++)
        {
            for (int x = 0; x < NumOfXVertices; x++)
            {
                ...
                if (y == NUM_OF_Y_VERTICES - 1)//looking for the topmost row of y 
                {
                    _topVerticesIndex[x] = y * NumOfXVertices + x;//storing the y values
                }
            }
        }
